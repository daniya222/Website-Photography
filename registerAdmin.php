        		...
        		<div class="col-md-4 col-sm4 col-xs-12">
        			...
        			<h3 align="center">Pixel&#8734;ks Register Admin</h3><br>
						...
						<div class="form-group">
        					<h4>Full Name</h4>
        					<input type="text" name="adminName" class="form-control fa-border" id="adminName" placeholder="Enter your full name">
        				</div>
        				<div class="form-group">
        					<h4>Username</h4>
        					<input type="text" name="username" class="form-control fa-border" id="username" placeholder="Enter your username">
        				</div>
        				<div class="form-group">
        					<h4>Password</h4>
        				...
        				<input type="submit" name="loginAdmin" id="loginAdmin"  class="btn btn-success btn-lg " value="Submit"></button><br>
