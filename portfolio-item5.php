...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="Image/Ceremony/c1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Ceremony/c2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Ceremony/c3.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <h3>Ceremony Photography</h3>
                <p>Ceremony Photography is an event where at that time there is a beautiful moment and the moment we can capture it with our camera. As for the event may include events mepades or which can also be called with cutting teeth, there is also pengabenan that can be interpreted by burning corpses, and others.</p>
            </div>
