                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="Image/Food/f1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Food/f2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Food/f3.jpg" alt="">
                        </div>
                    </div>
