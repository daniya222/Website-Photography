    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="Image/Wedding/w1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Wedding/w2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="Image/Wedding/w3.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <p>Wedding photography is the photography of activities relating to weddings. It encompasses photographs of the couple before marriage (for announcements, portrait displays, or thank you cards) as well as coverage of the wedding and reception (sometimes referred to as the wedding breakfast in non-US countries). It is a major branch of commercial photography, supporting many specialists.</p>
            </div>
